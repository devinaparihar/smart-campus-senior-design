    ...
    for i in range(5000):
        ...
        with torch.no_grad():
            ...
            if test_loss.item() < min_loss:
                ...
                loss, means, y_test, mask_test = forward_pass_batch(net, x, mask, N_COMPONENTS)
                min_means = means
                min_y = y_test
                min_mask = mask_test
                ...
                loss, means, y, mask = forward_pass_batch(net, x, mask, N_COMPONENTS)
                print("Means:\n{}".format(means))
                print("Target:\n{}".format(y))
